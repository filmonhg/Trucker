...
class KafkaSpout(Spout):
	...
	def initialize(self, stormconf, context):
		...
		# 								'zebra', 'elephant'])
		self.kafka = KafkaClient("ec2-52-8-124-34.us-west-1.compute.amazonaws.com:9092")
		self.consumer = SimpleConsumer(self.kafka, "my_group", "real_time_data", max_buffer_size=1310720000)
